...
public class GenerateJsonSchema {
  ...
  private static List<ServiceDescriptor> buildEndpointList() {
    ...
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .urlPattern("")
        .filters(
            new Field[] {new FieldBuilder().name("profile").type(StringType.class).build(),
    ...
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .urlPattern("")
        .filters(
            new Field[] {new FieldBuilder().name("selection").type(StringType.class).build(),
    ...
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .returnType(
            new ObjectBuilder().fields(
                new Field[] {
                    new FieldBuilder().name("affectedPairings").type(getPairingCollectionType())
                        .build(),
                    new FieldBuilder().name("alertCount").type(StringType.class).build(),
                    new FieldBuilder().name("date").type(DateTimeType.UTC_DATE).build(),
                    new FieldBuilder().name("flightCount").type(StringType.class).build(),
                    new FieldBuilder().name("openPairings").type(getPairingCollectionType())
                        .build(),
                    new FieldBuilder().name("pairingsCount").type(StringType.class).build(),
                    new FieldBuilder().name("scheduledPairings").type(getPairingCollectionType())
                        .build(),}).build()).build());
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .returnType(
            new CollectionBuilder().itemType(
                new ObjectBuilder()
                    .fields(
                        new Field[] {
                            new FieldBuilder().name("distributionPercentage")
                                .type(DoubleType.class).build(),
                            new FieldBuilder().name("tbdAdditionalData").type(StringType.class)
            ...
            new CollectionBuilder().itemType(
                new ObjectBuilder().fields(
                    new Field[] {
                        ...
                        new FieldBuilder().name("fromAirport").type(getAirportType()).build(),
                        new FieldBuilder().name("toAirport").type(getAirportType()).build(),
    ...
    endpoints
        .add(new ServiceDescriptorBuilder()
            ...
            .urlPattern("")
            .filters(
                new Field[] {new FieldBuilder().name("profileId").type(StringType.class).build(),})
            .returnType(
                new CollectionBuilder().itemType(
                    new ObjectBuilder().fields(
                        new Field[] {
    ...
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .description("")
        .urlPattern("")
        .filters(new Field[] {new FieldBuilder().name("profileId") // TODO double-check this; it
                                                                   // seems invalid
            .type(StringType.class).build(),})
        .returnType(
            new CollectionBuilder().itemType(
        ...
        .returnType(
            new CollectionBuilder().itemType(
                new ObjectBuilder().fields(
                    new Field[] {
                        new FieldBuilder().name("date").type(DateTimeType.UTC_DATE).build(),
                        new FieldBuilder().name("totalPairings").type(Int32.class).build(),
                        new FieldBuilder().name("totalFlights").type(Int32.class).build(),
                        new FieldBuilder().name("scheduledAlertsCount").type(Int32.class).build(),
                        new FieldBuilder().name("irropAlertsCount").type(Int32.class).build(),
                        new FieldBuilder().name("openAlertsCount").type(Int32.class).build(),
                        new FieldBuilder().name("totalAlertsCount").type(Int32.class).build(),
                        new FieldBuilder()
                            .name("totalsByAlertType")
                            .type(
                                new ObjectBuilder().fields(
                                    new Field[] {
                                        new FieldBuilder().name("block").type(Int32.class).build(),
                                        new FieldBuilder().name("duty").type(Int32.class).build(),
                                        new FieldBuilder().name("farStaffing").type(Int32.class)
                                            .build(),
                                        new FieldBuilder().name("farCrewRest").type(Int32.class)
                                            .build(),
                                        new FieldBuilder().name("farQualifications")
                                            .type(Int32.class).build(),
                                        new FieldBuilder().name("farEntryDocumentation")
                                            .type(Int32.class).build(),
                                        new FieldBuilder().name("cancellation").type(Int32.class)
                                            .build(),
                                        new FieldBuilder().name("delay").type(Int32.class).build(),
                                        new FieldBuilder().name("missconnection").type(Int32.class)
                                            .build(),
                                        new FieldBuilder().name("crewRestContract")
                                            .type(Int32.class).build(),
                                        new FieldBuilder().name("taxi").type(Int32.class).build(),
                                        new FieldBuilder().name("uaStaffing").type(Int32.class)
                                            .build(),
                                        new FieldBuilder().name("unassignedInbound")
                                            .type(Int32.class).build(),
                                        new FieldBuilder().name("flightOnTime").type(Int32.class)
        ...
        .filters(
            new Field[] {
                ...
                new FieldBuilder()
                    .name("sortType")
                    .possibleValues(
                        new String[] {"tailNumber", "scheduledDepartureTime",
                            "estimatedDepartureTime", "actualDepartureTime",
                            "scheduledArrivalTime", "estimatedArrivalTime", "actualArrivaleTime",
                            "highestSeverityFirst",}).type(StringType.class).build(),})
        .returnType(
            new CollectionBuilder().itemType(
                new ObjectBuilder()
                    .fields(
                        new Field[] {
                            ...
                            new FieldBuilder().name("fromAirport").type(getAirportType()).build(),
                            new FieldBuilder().name("toAirport").type(getAirportType()).build(),
                            new FieldBuilder().name("severityIndicator").type(StringType.class)
                                .build(),
                            new FieldBuilder().name("alertTypeCategory").type(StringType.class)
                                .build(),
                            new FieldBuilder().name("alertTypeSubCategory").type(StringType.class)
                                .build(),
                            new FieldBuilder().name("local.assignedIndicator")
                                .type(BooleanType.class).build(),
                            new FieldBuilder().name("local.watchedByMeIndicator")
                                .type(BooleanType.class).build(),}).build()).build()).build());
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .filters(
            new Field[] {
                ...
                new FieldBuilder()
                    ...
                    .possibleValues(
                        new String[] {"flightNumber", "scheduledDepartureTime",
                            "estimatedDepartureTime", "actualDepartureTime",
                            "scheduledArrivalTime", "estimatedArrivalTime", "actualArrivaleTime",
                            "highestSeverityFirst",}).build(),})
        .returnType(
            new CollectionBuilder().itemType(
                new ObjectBuilder()
                    .fields(
        ...
        .returnType(
            new ObjectBuilder().fields(
                new Field[] {
                    ...
                    new FieldBuilder().name("otherAlertsAffectingThisSameFlight").type(Int32.class) // FIXME
                                                                                                    // Validate
                                                                                                    // type
                        .build(),
                    new FieldBuilder().name("watchersCount").type(Int32.class).build(),
                    new FieldBuilder().name("assignedIndicator").type(StringType.class) // FIXME
                                                                                        // validate
                                                                                        // type
                        .build(),
                    new FieldBuilder().name("pairingId").type(StringType.class).build(),
                    new FieldBuilder().name("affectedFACount").type(Int32.class).build(),
                    new FieldBuilder().name("affectedPilotsCount").type(Int32.class).build(),
                    new FieldBuilder().name("lastUpdated").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                        .build(),
                    new FieldBuilder().name("flightNumber").type(StringType.class).build(),
                    new FieldBuilder().name("fromAirport").type(getAirportType()).build(),
                    new FieldBuilder().name("toAirport").type(getAirportType()).build(),
    ...
    endpoints.add(new ServiceDescriptorBuilder()
        ...
        .urlPattern("")
        .filters(
            new Field[] {new FieldBuilder().name("flightNumber").type(StringType.class).build(),})
        .returnType(
            new ObjectBuilder()
                .fields(
                    new Field[] {
                        ...
                        new FieldBuilder()
                            ...
                            .type(
                                new ObjectBuilder().fields(
                                    new Field[] {
                                        new FieldBuilder().name("onTime").type(BooleanType.class)
                                            .build(),
                                        new FieldBuilder().name("missconnected")
                                            .type(BooleanType.class).build(),
                                        new FieldBuilder().name("delayed").type(BooleanType.class)
                                            .build(),
                                        new FieldBuilder().name("inMaintenance")
                                            .type(BooleanType.class).build(),
                                        new FieldBuilder().name("canceled").type(BooleanType.class)
                                            .build(),
                                        new FieldBuilder().name("inProgress")
                                            .type(BooleanType.class).build(),
                                        new FieldBuilder()
                                            .name("decision")
                                            .type(StringType.class)
                                            .possibleValues(
                                                new String[] {"pending-delay", "pending-on-time"})
                                            .build(),}).build()).build(),
                        new FieldBuilder().name("scheduledDepartureTimestamp")
                            .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
                        new FieldBuilder().name("scheduledArrivalTimestamp")
                        ...
                        new FieldBuilder().name("scheduledFlightTime")
                            .type(DateTimeType.DURATION_MINUTES).build(),
                        new FieldBuilder().name("fdpCco").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
                        new FieldBuilder().name("blkCco").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
                        new FieldBuilder().name("bmt").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
                        new FieldBuilder().name("taxiIn").type(DateTimeType.DURATION_MINUTES)
                            .build(),
                        new FieldBuilder().name("dispatcher").type(StringType.class).build(),
                        new FieldBuilder().name("departureGate").type(StringType.class).build(),
                        new FieldBuilder().name("arrivalGate").type(StringType.class).build(),
                        new FieldBuilder()
                            .name("flightHistory")
                            .type(
                                new CollectionBuilder().itemType(
                                    new ObjectBuilder().fields(
                                        new Field[] {
                                            new FieldBuilder()
                                                ...
                                                .type(StringType.class)
                                                .possibleValues(
                                                    new String[] {"arrival_time", "departure_time",
                                                        "pairings"}).build(),
                                            new FieldBuilder().name("timestamp")
                                                .type(DateTimeType.UTC_TIMESTAMP_SECONDS).build(),
                        ...
                        new FieldBuilder().name("associatedPairings")
                            .type(getPairingSummaryCollectionType()).build(),}).build()).build());
            ...
            new CollectionBuilder().itemType(
                new ObjectBuilder().fields(
                    new Field[] {
                        ...
                        new FieldBuilder().name("crewAffected").type(StringType.class).build(),
                        ...
                        new FieldBuilder().name("watchers").type(getWatchers()).build(),
                ...
                new CollectionBuilder()
                    .itemType(
                        new ObjectBuilder()
                            .fields(
                                new Field[] {
                                    new FieldBuilder().name("pairingNumber").type(StringType.class)
                                        .build(),
                                    new FieldBuilder().name("dayCount").type(Int32.class).build(),
                                    new FieldBuilder().name("segmentCount").type(Int32.class)
                                        .build(),
                                    new FieldBuilder().name("flightDuration")
                                        .type(DateTimeType.DURATION_MINUTES).build(),
                                    new FieldBuilder().name("flightDuration2") // TODO clarify why
                                                                               // there are 2 times
                                        .type(DateTimeType.DURATION_MINUTES).build(),
                                    new FieldBuilder()
                                        .name("layoverCities")
                                        .type(
                                            new CollectionBuilder().itemType(StringType.class)
                                                .build()) // TODO decide whether this is a string or
                                                          // an airport object
                                        .build(),
                                    new FieldBuilder().name("hoursAwayCount")
                                        .type(DateTimeType.DURATION_HOURS).build(),
                                    new FieldBuilder().name("dhdTime")
                                        .type(DateTimeType.DURATION_MINUTES).build(),
                                    new FieldBuilder().name("guaranteedTime")
                                        .type(DateTimeType.DURATION_MINUTES).build(),
                                    new FieldBuilder().name("guaranteedTime2") // TODO clarify why
                                                                               // there are 2 times
                                        .type(DateTimeType.DURATION_MINUTES).build(),
                                    new FieldBuilder().name("payTimeInHours")
                                        .type(DateTimeType.DURATION_HOURS).build(),
                                    new FieldBuilder()
                                        .name("dutyPeriods")
                                        .type(
                                                        ...
                                                        .fields(
                                                            new Field[] {
                                                                ...
                                                                new FieldBuilder()
                                                                    ...
                                                                    .type(
                                                                        DateTimeType.UTC_TIMESTAMP_MINUTES)
                                                                    .build(),
                                                                new FieldBuilder()
                                                                    .name(
                                                                                ...
                                                                                new Field[] {
                                                                                    new FieldBuilder()
                                                                                        .name(
                                                                                            "lastUpdated")
                                                                                        .type(
                                                                                            DateTimeType.UTC_TIMESTAMP_SECONDS)
                                                                                        .build(),
                                                                                    new FieldBuilder()
                                                                                        .name(
                                                                                            "noseNumber")
                                            ...
                                            new ObjectBuilder().fields(
                                                new Field[] {
                                                    ...
                                                    new FieldBuilder()
                                                        ...
                                                        .type(getTransportationType()).build(),
                                                    new FieldBuilder().name("hotel")
                                                        .type(getHotelType()).build(),
                                                    new FieldBuilder()
                                                        .name("toAirportTransportation")
                                                        .type(getTransportationType()).build(),})
                                                .build()).build(),
                                    new FieldBuilder().name("crewInformation")
                                        .type(getCrewInformationCollectionType()).build(),})
                            .build()).build()).build());
    endpoints.add(new ServiceDescriptorBuilder()
                                ...
                                new CollectionBuilder().itemType(
                                    new ObjectBuilder().fields(
                                        new Field[] {
                                            ...
                                            new FieldBuilder().name("type").type(StringType.class)
                                                .possibleValues(new String[] {
                                                // FIXME provide possible values
                                                    }).build(),
                                            new FieldBuilder()
                                                .name("pairingsAffected")
                                                // TODO is this an enumeration or a count?
                                                .type(
                                                    new CollectionBuilder().itemType(
                                                        StringType.class).build()) // TODO Validate
                                                .build(),
                                            ...
                                            new FieldBuilder().name("affectedPilotsCount")
                                                .type(Int32.class).build(),}).build()).build())
                            .build(),
                        new FieldBuilder().name("lastUpdate")
  ...
  private static Type getTransportationType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("companyName").type(StringType.class).build(),
            new FieldBuilder().name("pickupTime").type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
            new FieldBuilder().name("pickupLocation").type(StringType.class).build(),
            new FieldBuilder().name("phone").type(StringType.class).build(),
            new FieldBuilder().name("voucherNumber").type(StringType.class).build(),}).build();
  }

  private static Type getHotelType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("name").type(StringType.class).build(),
            new FieldBuilder().name("address").type(getAddressType()).build(),
            new FieldBuilder().name("phone").type(StringType.class).build(),
            new FieldBuilder().name("reservationNumber").type(StringType.class).build(),}).build();
  }

  private static Type getAddressType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("address1").type(StringType.class).build(),
            new FieldBuilder().name("address2").type(StringType.class).build(),
            new FieldBuilder().name("city").type(StringType.class).build(),
            new FieldBuilder().name("stateOrProvince").type(StringType.class).build(),
            new FieldBuilder().name("postalCode").type(StringType.class).build(),
            new FieldBuilder().name("country").type(StringType.class).build(),}).build();
  }
  ...
  private static Type getCrewInformationType() {
    return new ObjectBuilder().fields(
        new Field[] {
            new FieldBuilder().name("id").type(StringType.class).build(),
            new FieldBuilder().name("photoUrl").type(StringType.class).build(),
            new FieldBuilder().name("firstName").type(StringType.class).build(),
            new FieldBuilder().name("lastName").type(StringType.class).build(),
            new FieldBuilder().name("position").type(StringType.class) // TODO clarify/validate this
                .build(),
            new FieldBuilder().name("last3Landings")
                .type(new CollectionBuilder().itemType(DateTimeType.UTC_TIMESTAMP_MINUTES).build())
                .build(),
            new FieldBuilder().name("nextExpirationDate").type(DateTimeType.UTC_DATE).build(),})
        .build();
  }
  ...
  private static ObjectType getPairingSummaryType() {
    return new ObjectBuilder()
        .fields(
            new Field[] {
                new FieldBuilder().name("pairingId").type(StringType.class).build(),
                new FieldBuilder().name("pairingCode").type(StringType.class).build(),
                new FieldBuilder().name("domicile").type(getDomicileType()).build(),
                new FieldBuilder().name("dhd").type(StringType.class) // FIXME find out what this is
                    .build(),
                new FieldBuilder().name("status").type(StringType.class) // FIXME validate type
                    .possibleValues(new String[] {"LH", "RSV"}).build(),
                new FieldBuilder().name("crewMembers").type(getCrewMemberSummaryCollectionType())
                    .build(),
                new FieldBuilder().name("alertType").type(StringType.class).build(),
                new FieldBuilder().name("lastUpdated").type(DateTimeType.UTC_TIMESTAMP_SECONDS)
                    .build(),}).build();
  }
  ...
  private static Field[] getTimeframeAndTypeFieldArray() {
    return new Field[] {
        getTimeframeField(),
        new FieldBuilder().name("type").type(StringType.class)
            .possibleValues(new String[] {"severity", "type"}).build()};
  }

  private static Field getTimeframeField() {
    return new FieldBuilder().name("timeframe").type(StringType.class)
        .possibleValues(new String[] {"2h", "6h", "8h", "12h", "24h", "36h", "48h", "72h"}).build();
  }
  ...
  private static ObjectType getPairingType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("pairingId").type(StringType.class).build(),
            new FieldBuilder().name("pairingCode").type(StringType.class).build(),
            new FieldBuilder().name("domicile").type(getDomicileType()).build(),
            new FieldBuilder().name("date").type(StringType.class).build(),
            new FieldBuilder().name("flightCount").type(StringType.class).build(),
            new FieldBuilder().name("pairingsCount").type(StringType.class).build(),
            new FieldBuilder().name("dutyPeriods").type(getDutyPeriodCollectionType()).build(),
            new FieldBuilder().name("crewMembers").type(getCrewMemberCollectionType()).build(),
            new FieldBuilder().name("flightLegs").type(getFlightLegCollectionType()).build(),})
        .build();
  }
  ...
  private static Type getDutyPeriodType() {
    return new ObjectBuilder()
        .fields(
            new Field[] {
                new FieldBuilder().name("dutyPeriodId").type(StringType.class).build(),
                ...
                new FieldBuilder().name("actualEndTimestamp")
                    .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
                new FieldBuilder().name("duties").type(getDutyCollectionType()).build(),}).build();
  }
  ...
  private static Type getDutyType() {
    return new ObjectBuilder().fields(
        new Field[] {
            new FieldBuilder().name("dutyId").type(StringType.class).build(),
            new FieldBuilder().name("dutyType").type(StringType.class).build(),
            new FieldBuilder().name("flightLegId").type(StringType.class).build(),
            new FieldBuilder().name("sequenceNumber").type(Int32.class).build(),
            new FieldBuilder().name("deadHead").type(BooleanType.class).build(),
            new FieldBuilder().name("scheduledStartTimestamp")
                .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
            new FieldBuilder().name("scheduledEndTimestamp")
                .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
  ...
  private static Type getCrewMemberSummaryType() {
    return new ObjectBuilder().fields(
        new Field[] {
            ...
            new FieldBuilder().name("firstName").type(StringType.class).build(),
            new FieldBuilder().name("lastName").type(StringType.class).build(),
            new FieldBuilder().name("class").type(StringType.class)
                .possibleValues(new String[] {"Pilot", "FA"}).build(),
            new FieldBuilder().name("laborUnionCode").type(StringType.class)
                .possibleValues(new String[] {"sUA", "sCO"}).build(),
            new FieldBuilder().name("seniority").type(StringType.class).build(),
            new FieldBuilder().name("domicileId").type(StringType.class).build(),}).build();
    ...
    return new ObjectBuilder().fields(
        new Field[] {
            ...
            new FieldBuilder().name("class").type(StringType.class)
                .possibleValues(new String[] {"Pilot", "FA"}).build(),
            new FieldBuilder().name("laborUnionCode").type(StringType.class)
                .possibleValues(new String[] {"sUA", "sCO"}).build(),}).build();
  ...
  private static Type getFlightLegType() {
    return new ObjectBuilder().fields(
        new Field[] {
            ...
            new FieldBuilder().name("fromAirport").type(getAirportType()).build(),
            new FieldBuilder().name("toAirport").type(getAirportType()).build(),
            new FieldBuilder().name("aircraft").type(getAircraftType()).build(),
            new FieldBuilder().name("flightNumber").type(StringType.class).build(),
            new FieldBuilder().name("scheduledDepartureTimestamp")
                .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
            new FieldBuilder().name("scheduledArrivalTimestamp")
            ...
            new FieldBuilder().name("actualDepartureTimestamp")
                .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
            new FieldBuilder().name("actualArrivalTimestamp")
                .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),}).build();
  }

  private static Type getAircraftType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("aircraftId").type(StringType.class).build(),
            new FieldBuilder().name("type").type(StringType.class).build(),
            new FieldBuilder().name("tailNumber").type(StringType.class).build(),}).build();
  }

  private static ObjectType getDomicileType() {
    return new ObjectBuilder().fields(
        new Field[] {
            new FieldBuilder().name("domicileId").type(StringType.class).build(),
            new FieldBuilder().name("name").type(StringType.class).build(),
            new FieldBuilder().name("airports")
                .type(new CollectionBuilder().itemType(getAirportType()).build()).build(),})
        .build();
  }
  ...
  private static ObjectType getAirportType() {
    return new ObjectBuilder().fields(
        new Field[] {
            new FieldBuilder().name("airportCode").type(StringType.class).build(),
            new FieldBuilder().name("locationCoarseAddress").type(getCoarseAddressType()).build(),
            new FieldBuilder().name("anchorCitiesCoarseAddress")
                .type(getCoarseAddressCollectionType()).build(),}).build();
  }
  ...
  private static ObjectType getCoarseAddressType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("city").type(StringType.class).build(),
            new FieldBuilder().name("stateOrProvince").type(StringType.class).build(),
            new FieldBuilder().name("country").type(StringType.class).build(),}).build();
  }
