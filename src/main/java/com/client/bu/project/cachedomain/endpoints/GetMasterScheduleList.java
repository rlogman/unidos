	...
	public GetMasterScheduleList() {
		...
		.returnType(new CollectionBuilder().itemType(new ObjectBuilder().fields(new Field[] {
				...
				new FieldBuilder().name("domicile")
						...
						.build(),
				new FieldBuilder().name("cellPhone")
						.type(StringType.class)
						.build(),
				new FieldBuilder().name("alertsAssociated")
						.type(new CollectionBuilder().itemType(new ObjectBuilder().fields(new Field[] {
								...
								new FieldBuilder().name("local.assignee")
										.type(StringType.class)
										.build(),
								new FieldBuilder().name("local.watchers")
						...
						.build()).build())
						.build(),
				new FieldBuilder().name("monthsAvailable").type(new CollectionBuilder().itemType(new ObjectBuilder().fields(new Field[] {
						new FieldBuilder().name("month")
								.type(DateTimeType.UTC_MONTH)
								.build(),
						new FieldBuilder().name("flightSegments")
								.type(new CollectionBuilder().itemType(getMasterScheduleFlightSegmentType()).build())
								.build(),
						new FieldBuilder().name("nonFlyingSegments")
						...
						new FieldBuilder().name("flyingAlerts")
								...
								.build(),
						new FieldBuilder().name("nonFlyingAlerts")
								.type(new CollectionBuilder().itemType(getMasterScheduleAlertType()).build())
								.build(),
						}).build()).build())
						.build(),
