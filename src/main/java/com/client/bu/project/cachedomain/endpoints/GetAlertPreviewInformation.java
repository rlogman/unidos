...
public class GetAlertPreviewInformation extends ServiceDescriptorBuilder {
  ...
  public GetAlertPreviewInformation() {
    ...
    .returnType(new ObjectBuilder().fields(new Field[] {
        ...
        new FieldBuilder().name("otherAlertsAffectingThisSameFlight").type(Int32.class) // FIXME Validate type
            .build(),
        new FieldBuilder().name("watchersCount").type(Int32.class).build(),
        new FieldBuilder().name("assignedIndicator").type(StringType.class) // FIXME validate type
            .build(),
