...
public class GetAlertPreviewInformation extends ServiceDescriptorBuilder {
  ...
  public GetAlertPreviewInformation() {
    ...
    this.description("");
    this.urlPattern("");
    this.filters(new Field[] {new FieldBuilder().name("alertId").type(StringType.class).build(),});
    this.returnType(
        new ObjectBuilder().fields(
            new Field[] {
                ...
                new FieldBuilder().name("fromAirport").type(CrewSchedulingUtils.getAirportType())
                    .build(),
