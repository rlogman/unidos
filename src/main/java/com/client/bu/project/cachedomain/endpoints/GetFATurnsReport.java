...
public class GetFATurnsReport extends ServiceDescriptorBuilder {
        ...
        .filters(
            new Field[] {
                ...
                new FieldBuilder().name("toDateTime").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                    .build(), new FieldBuilder().name("station").type(StringType.class).build(),})
        .parameters(
            new Field[] {new FieldBuilder().name("sortBy").type(StringType.class)
                .possibleValues(new String[] {"operationalDeparture", "operationalArrival"})
                .build(),})
        .returnType(
                        ...
                        new FieldBuilder()
                            ...
                            .type(
                                new ObjectBuilder()
                                    .fields(
                                        new Field[] {
                                            new FieldBuilder().name("id-dt").type(StringType.class)
                                                .build(),
                                            new FieldBuilder()
                                                .name("pos")
                                                .type(
                                                    new CollectionBuilder().itemType(
                                                        StringType.class).build()).build(),
                                            new FieldBuilder().name("domicile")
                                                .type(StringType.class).build(),
                                            new FieldBuilder().name("count").type(Int32.class)
                                                .build(),}).build()).build(),
                        new FieldBuilder().name("inboundSegment").type(getTurnSegmentType())
                            .build(),
                        new FieldBuilder().name("acm").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
                        new FieldBuilder().name("adt").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
                        new FieldBuilder().name("l/o").type(DateTimeType.UTC_TIMESTAMP_MINUTES)
                            .build(),
  ...
  private static ObjectType getTurnSegmentType() {
    return new ObjectBuilder().fields(
        new Field[] {new FieldBuilder().name("flt").type(Int32.class).build(),
