...
public class GetLineholdersOrReservesList extends ServiceDescriptorBuilder {
	...
	public GetLineholdersOrReservesList() {
		...
		.urlPattern("")
		.filters(new Field[] {
				new FieldBuilder().name("dateFrom")
						.type(DateTimeType.UTC_DATE)
						.build(),
				new FieldBuilder().name("dateTo")
						.type(DateTimeType.UTC_DATE)
						.build(),
				...
				new FieldBuilder().name("lineholderFlightArrivalTimeTo")
						...
						.build(),
				getCrewTypeField(),
				new FieldBuilder().name("positions")
						.type(StringType.class)	// TODO validate this type
						.build(),
				new FieldBuilder().name("fleetType")
						.type(StringType.class)	// TODO validate this type
						.build(),
				new FieldBuilder().name("lineholderFlightArrivalTimeTo")
		...
		.returnType(new ObjectBuilder().fields(new Field[] {
				new FieldBuilder().name("totalResults")
						.type(Int32.class)
						.build(),
				new FieldBuilder().name("lineholderData").type(new ObjectBuilder().fields(new Field[] {
						new FieldBuilder().name("totalLineholderCount")
								.type(Int32.class)
								.build(),
						new FieldBuilder().name("lineholders").type(new CollectionBuilder().itemType(new ObjectBuilder().fields(new Field[] {
								new FieldBuilder().name("domicile")
								...
								new FieldBuilder().name("employeeData")
										.type(new ObjectBuilder().fields(new Field[] {
												new FieldBuilder().name("position")
														.type(StringType.class)
														.build(),
												new FieldBuilder().name("idNumber")
														.type(StringType.class)
														.build(),
								...
								new FieldBuilder().name("nextFlightData")
										...
										.build(),
								new FieldBuilder().name("tbdLegalInfo")
						...
						.build(),
				new FieldBuilder().name("reservesData").type(new ObjectBuilder().fields(new Field[] {
						...
						new FieldBuilder().name("reserves").type(new CollectionBuilder().itemType(new ObjectBuilder().fields(new Field[] {
								...
								new FieldBuilder().name("pairingNumber")
										.type(StringType.class)
										.build(),
								new FieldBuilder().name("nextPairingNumber")
										.type(StringType.class)
										.build(),
								new FieldBuilder().name("typeOfReserve")
										.type(StringType.class)
										.build(),
								new FieldBuilder().name("seniority")
										.type(StringType.class)
								...
								new FieldBuilder().name("startDate")
										.type(DateTimeType.UTC_DATE)
										.build(),
								new FieldBuilder().name("startTime")
										.type(DateTimeType.UTC_TIMESTAMP_MINUTES)
										.build(),
								new FieldBuilder().name("daysAvailable")
										.type(Int32.class)
										.build(),
								new FieldBuilder().name("tbdLegalInfo")
										.type(StringType.class)	// FIXME define this
