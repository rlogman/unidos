        ...
        .filters(
            new Field[] {
                ...
                new FieldBuilder().name("lineholderFlightArrivalTimeTo")
                    .type(DateTimeType.UTC_TIMESTAMP_MINUTES).build(),
                getCrewTypeField(),
                new FieldBuilder().name("positions").type(StringType.class) // TODO validate this
                                                                            // type
                    .build(),
                new FieldBuilder().name("fleetType").type(StringType.class) // TODO validate this
                                                                            // type
                    .build(),
                                                                ...
                                                                .fields(
                                                                    new Field[] {
                                                                        ...
                                                                        new FieldBuilder()
                                                                            .name("blockTime")
                                                                            .type(
                                                                                DateTimeType.DURATION_MINUTES) // FIXME
                                                                                                               // provide
                                                                                                               // right
                                                                                                               // type
                                                                            .build(),
