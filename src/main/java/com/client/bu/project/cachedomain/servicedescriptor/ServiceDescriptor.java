...
public class ServiceDescriptor {
  ...
  public ServiceDescriptor(String name, String description, String urlPattern, List<Field> filters,
      List<Field> parameters, Type returnType, Maturity maturity,
      Set<AvailabilityLevel> availableTo, Set<Protocol> protocols) {
    super();
    this.name = name;
  ...
  public ServiceDescriptor(String name, String description, String urlPattern, Field[] filters,
      Field[] parameters, Type returnType, Maturity maturity, AvailabilityLevel[] availableTo,
      Protocol[] protocols) {
